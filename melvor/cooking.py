class CookingBonuses:
    def __init__(self, chance_to_preserve, chance_to_double, chance_to_perfect, success_rate):
...
class Cooking:
    def __init__(self, base_heal, cook_time, recipe, output, bonuses):
    ...
    def time_to_use_all_ingredients(self, amount):
        ...
        return (amount / self.recipe) * self.cook_time * preserve_mod
    ...
    def will_produce_normal(self, amount):
        ...
        return (amount / self.recipe) * self.output * double_mod * success_mod * (1 - perfect_mod)
    ...
    def will_produce_perfect(self, amount):
        ...
        return (amount / self.recipe) * self.output * double_mod * success_mod * perfect_mod
